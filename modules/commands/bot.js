  ...
  handleEvent: async function({ api, message }) {
    ...
    try {
      ...
      if (input.includes("chutiya bot") || input.includes("chutiye bot") || input.includes("chumtiya bot")) {
       ...
       return api.sendMessage("is nazar se srif muhje 𝐁𝐀𝐑𝐅𝐈𝐈🥀💞 Boss dekh sak thi hai", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
       ...
       if ((event.body.toLowerCase() == "shaan Kon hai") || (event.body.toLowerCase() == "shaan ap kon ho")) {
